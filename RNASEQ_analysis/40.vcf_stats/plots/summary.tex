...
%   plot-vcfstats BSA_pools.vcf.stats -p plots/
%
...
BSA\_p & 637,047 & 1.59 & 1.60 & 88,473 & -- & -- & 75,856 & 12,882 \\ 
%
...
BSA\_p & 9.6\% & 1.19 & 13.4\% & 0.000 &  28,912 &3,695 \\ 
\end{tabular}
\vspace{2em}
\begin{itemize}[-]
\setlength{\itemsep}{0pt}
\item BSA\_p .. \texttt{\footnotesize BSA\_pools.vcf.gz}
\end{itemize}\end{minipage}}


% SNP and indel counts by AF
%
\hslide{}{\vbox{\noindent\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=23cm]{counts_by_af.snps}\\%
\noindent\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=23cm]{counts_by_af.indels}}}

% Ts/Tv by AF
%
\hslide{Ts/Tv by AF}{\includegraphics[type=pdf,ext=.pdf,read=.pdf,width=15cm]{tstv_by_af.0}}
